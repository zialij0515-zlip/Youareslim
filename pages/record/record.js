...
Page({
  data: { activeType:'breakfast', typeOptions:[{key:'breakfast',name:'早餐'},{key:'lunch',name:'午餐'},{key:'dinner',name:'晚餐'},{key:'sport',name:'运动'},{key:'treat',name:'放纵餐'}], sportOptions:[{key:'run',name:'跑步'},{key:'tennis',name:'网球'},{key:'incline',name:'爬坡'},{key:'aerobic',name:'有氧'},{key:'anaerobic',name:'无氧'},{key:'stretch',name:'拉伸'}], durationItems:[{key:'aerobic',name:'有氧'},{key:'anaerobic',name:'无氧'}], mealMoods:[{key:'full',name:'很满足',icon:'/assets/record/mood-full.png'},{key:'good',name:'好吃',icon:'/assets/record/mood-good.png'},{key:'hungry',name:'有点饿',icon:'/assets/record/mood-hungry.png'}], sportMoods:[{key:'full',name:'运动达标',icon:'/assets/record/mood-full.png'},{key:'good',name:'浅浅运动',icon:'/assets/record/mood-good.png'},{key:'hungry',name:'没有运动',icon:'/assets/record/mood-hungry.png'}], moods:[{key:'full',name:'很满足',icon:'/assets/record/mood-full.png'},{key:'good',name:'好吃',icon:'/assets/record/mood-good.png'},{key:'hungry',name:'有点饿',icon:'/assets/record/mood-hungry.png'}], mood:'good', note:'', images:[], sportItems:[], durations:{aerobic:'',anaerobic:''}, sampleImages:['/assets/record/food1.png','/assets/record/food2.png'], notePlaceholder:'记录食物和心情', saved:false, weight:'', inputWidth:170, bmiValue:'', weightLoss:'', dayCount:0, mealRate:0, sportRate:0 },
  ...
  inputDuration(e){ const key=e.currentTarget.dataset.key; const patch={durations:{...this.data.durations,[key]:e.detail.value},saved:false}; this.setData(patch); },
