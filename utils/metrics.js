...
function labelForBmi(value) { if (!value) return '待记录'; if (value < 18.5) return '偏低'; if (value < 24) return '正常范围'; if (value < 28) return '偏高'; return '偏高较多' }
module.exports = { bmi, bodyFat, calorieEstimate, labelForBmi }
